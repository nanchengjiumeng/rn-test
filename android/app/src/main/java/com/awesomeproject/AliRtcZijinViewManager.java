...
public class AliRtcZijinViewManager extends SimpleViewManager<SophonSurfaceView> {
    ...
    public AliRtcZijinViewManager(ReactApplicationContext reactContext, Number num) {
    ...
    private AliRtcAuthInfo generateAliRtcAuthInfo() {
        ...
        String channelId = "zijinRtc";
        String userId = "fb87630c-0415-4599-8aa0-6f4981e43589";
...
//        userInfo.setNonce("AK-58c28f37-48dc-4cb8-ab57-5b74dbea3a67"); //随机码。需要加上前缀AK-
//        String[] gslb = new String[]{"https://rgslb.rtc.aliyuncs.com"};
//        userInfo.setGslb(gslb);  //服务地址，当前请使用["https://rgslb.rtc.aliyuncs.com"]
//        userInfo.setTimestamp(1635143879); //令牌过期时间戳
//        userInfo.setToken("7282299070f35355cc83127004ce2d7ec5b34d3bd94fec4acf25a89b7799485b");     //加入频道Token
//        userInfo.setChannelId("zijinRtc"); //频道ID
//        userInfo.setUserId("androidYang");  //用户ID
//
//
//
////        mAliRtcEngine.subscribeAllRemoteAudioStreams(true);
////        mAliRtcEngine.subscribeAllRemoteVideoStreams(true);
        AliRtcAuthInfo userInfo = generateAliRtcAuthInfo();
        // 加入频道，参数1:鉴权信息 参数2:用户名
        mAliRtcEngine.joinChannel(userInfo, "wangyb");
    }
...
//            mAliRtcEngine.setDefaultSubscribeAllRemoteVideoStreams(false);//默认不订阅视频流
            ...
            //加入频道
            joinChannel();
//            mAliRtcEngine.publishLocalAudioStream(true);//发布音频流
//            mAliRtcEngine.publishLocalVideoStream(true);//发布视频流
        }
    }
